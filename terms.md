...
SpecDevShip is operated by **Corey Struzan**. For any questions about these Terms, contact us at **{{ POLICY_EMAIL }}**.
...
## 4. "Lifetime" Updates — What This Means

Where we describe the Skill Pack as including "lifetime updates," this specifically means:

- You will receive, at no additional charge, all future updates, bug fixes, and improvements made **to the Skill Pack product you purchased**, for as long as SpecDevShip continues to actively develop, update, and offer that specific product for sale.
- This includes additional AI coding agent editions released as part of the same Skill Pack product line (for example, if a Cursor, Copilot, or other agent edition is released later, it is included as an update to your existing purchase, not sold separately) — provided the Skill Pack remains an actively maintained, for-sale product at the time such an edition ships.
- "Lifetime" refers to the lifetime of **this specific product**, not to SpecDevShip as a company, nor to the buyer's own lifetime. If SpecDevShip discontinues the Skill Pack entirely and stops offering it for sale and stops updating it, our obligation to provide further updates ends at that point. You retain the right to keep and use whatever version of the Skill Pack you last received.
- "Lifetime updates" to the Skill Pack does **not** entitle you to any other, separate product SpecDevShip may release now or in the future under the SpecDevShip brand name — including, without limitation, different tools, guides, subscriptions, services, or unrelated skill packs. Each SpecDevShip product is a distinct purchase unless we explicitly state otherwise at the time of sale.
...
The Skill Pack, the Field Guide, our website, and all associated content, branding, and materials are the intellectual property of SpecDevShip and are protected by applicable copyright and other intellectual property laws. Purchasing a license under Section 3 does not transfer any ownership rights to you. All rights not expressly granted to you under Section 3 are reserved.
...
- Circumvent, disable, or interfere with any licensing, access, or delivery mechanism we use to distribute the products;
- Use automated means to scrape, copy, or redistribute our website content or product files beyond your own licensed use.

## 9. Disclaimer of Warranties

The products are provided **"as is" and "as available,"** without warranties of any kind, whether express or implied, including but not limited to implied warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not guarantee that the Skill Pack will produce any particular result in your projects, that it will be compatible with every AI coding agent or every version of an agent, or that it will be error-free or uninterrupted. Results from using any AI coding agent — with or without our products — depend heavily on factors outside our control, including the underlying AI model's own behavior.

## 10. Limitation of Liability

To the fullest extent permitted by law, SpecDevShip and its owners, contributors, and affiliates will not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits, data, or business opportunity, arising out of or related to your use of, or inability to use, our products — even if we have been advised of the possibility of such damages. Our total liability for any claim arising from your purchase will not exceed the amount you actually paid us for the product giving rise to the claim.
...
We may update, modify, improve, or discontinue any product (or any feature of it) at any time. We will make reasonable efforts to communicate significant changes to existing customers via email, but are not obligated to maintain any specific feature indefinitely.

## 13. Changes to These Terms

We may update these Terms from time to time. If we make material changes, we will update the "Last updated" date above and, where appropriate, notify existing customers by email. Continued use of our products after changes take effect constitutes acceptance of the revised Terms.

## 14. Governing Law

These Terms are governed by the laws of **the State of Wyoming, United States**, without regard to its conflict-of-law principles, except where applicable consumer-protection law in your own jurisdiction provides otherwise.

## 15. Contact Us

Questions about these Terms can be sent to **{{ POLICY_EMAIL }}**.
